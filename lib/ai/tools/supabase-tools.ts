...
export const searchAntibody = createSupabaseTool({
  ...
  parameters: z.object({
    ...
    ab_typo_param: z
      .string()
      .optional()
      .describe('Antibody type (e.g., "pab" for polyclonal antibody)'),
    ab_app_param: z
      .string()
      .optional()
      .describe('Antibody application (e.g., "IHC" for immunohistochemistry)'),
    ab_cross_param: z
      .string()
      .optional()
      .describe('Antibody cross-reactivity (e.g., "RAT")'),
    ab_host_param: z
      .string()
      .nullable()
      .optional()
      .describe('Antibody host organism'),
  }),
});

/**
 * Search for data in either the "surveys" or "countrys" tables
 */
export const searchEntity = createSupabaseTool({
  description:
    'Return all records from either the "surveys" or "countrys" table',
  functionPath: 'search_entity',
  parameters: z.object({
    type: z
      .enum(['surveys', 'countrys'])
      .describe('The table to search: "surveys" or "countrys"'),
  }),
});
